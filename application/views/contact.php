...
<body>
    ...
    <div class="container">
        ...
        <div class="mt-5 col-lg-12 mr-auto order-1 aos-init aos-animate d-flex align-content-center justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <form action="<?= site_url('home/contact/') ?>" method="post">
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <textarea name="isi_saran" id="" cols="30" rows="7" class="form-control" placeholder="Message"></textarea>
                    </div>
