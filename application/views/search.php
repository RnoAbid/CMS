...
<body>
        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto active" href="<?= base_url('home/galeri') ?>">Gallery</a></li>
                    ...
                    <li><a class="nav-link scrollto active" href="<?= base_url('home/contact'); ?>">Contact</a></li>
    ...
    <div class="container mt-5">
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-img"><img src="<?= site_url('assets/upload/konten/' . $konten->foto) ?>" class="img-fluid" alt=""></div>
            <div class="col-lg-4">
                            ...
                            <?php foreach ($results as $result) : ?>
                                <div class="col-md-4 mb-md-0">
                                    <div class="post-slider slider-sm">
                                        <img style="border-radius: 5%;" src="<?= site_url('assets/upload/konten/' . $result->foto) ?>" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-8 mt-2">
                                    <h3 class="h5">
                                        <a class="post-title" href="<?= site_url('home/artikel/' . $result->slug); ?>"><?= $result->judul ?></a>
                                    </h3>
                                    ...
                                    <p>
                                        ...
                                        if (strlen($keterangan) > $maxLength) {
                                            ...
                                            $shortText .= '... <a href="' . site_url('home/artikel/' . $kategoriSlug) . '">Baca Selengkapnya</a>';
                                        } else {
                                            $shortText = $keterangan .= ' <a href="' . site_url('home/artikel/' . $kategoriSlug) . '">Baca Selengkapnya</a>';
                                        }
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <ul>
                            ...
                            <?php foreach ($kategori as $aa) { ?>
                                <li><i class="bx bx-chevron-right"></i> <a href="<?= base_url('home/kategori/' . $aa['id_kategori']) ?>"><?= $aa['nama_kategori'] ?></a></li>
                            <?php } ?>
